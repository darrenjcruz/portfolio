        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <Avatar alt="Darren Cruz" src="portfolio\src\assets\Anime Me.jpg" sx={{display: {xs: 'none', md: 'flex'}}} />
                    ...
                    <Avatar alt="Darren Cruz" src="portfolio\src\assets\Anime Me.jpg" sx={{display: {xs: 'flex', md: 'none'}}}/>
