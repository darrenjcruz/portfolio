...
const PythonProject2 = {
    title: 'GUI Connect Four',
    images: [
...
const HTMLProject3 = {
    title: 'Recipe Finders Web Application',
    images: [
